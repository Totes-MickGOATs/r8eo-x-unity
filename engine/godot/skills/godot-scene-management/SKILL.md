...
- [reverse-engineering](../reverse-engineering/SKILL.md) — Scene loading chain tracing: boot → SceneManager → ResourceLoader → _ready() cascade
- [user-interaction-testing](../user-interaction-testing/SKILL.md) — Full menu navigation flow testing, scene transition verification
