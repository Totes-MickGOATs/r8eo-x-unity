...
{
    /// <summary>
    /// Full-flow and round-trip tests for GameFlowStateMachine.
    /// Basic transition and event tests live in GameFlowTransitionTests.cs.
    /// </summary>
    [TestFixture]
    public sealed class GameFlowFlowTests
    {
