...
{
    /// <summary>
    /// Unit tests for chassis tuning setter API on RCCar:
    /// SetSuspension, SetAxleSuspension, SetTraction, SetCrashParams,
    /// SetCentreOfMass, and SetMass.
    /// Motor/steering/throttle tests live in TuningApiMotorTests.cs.
    /// </summary>
