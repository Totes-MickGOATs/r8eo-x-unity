...
{
    /// <summary>
    /// Unit tests for motor-related tuning setter API on RCCar:
    /// SetMotorParams, SetThrottleResponse, SetSteeringParams, and SelectMotorPreset.
    /// </summary>
    public class TuningApiMotorTests
    {
        // ---- Constants ----
