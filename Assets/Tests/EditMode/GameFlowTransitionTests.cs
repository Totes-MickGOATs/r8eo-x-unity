...
{
    /// <summary>
    /// Basic state-machine transitions and event tests for GameFlowStateMachine.
    /// Full-flow and round-trip tests live in GameFlowFlowTests.cs.
    /// </summary>
    [TestFixture]
    public sealed class GameFlowTransitionTests
    {
