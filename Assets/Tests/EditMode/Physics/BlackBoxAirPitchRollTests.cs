...
{
    /// <summary>
    /// Black-box unit tests for AirPhysicsMath pitch and roll torque functions.
    /// GyroDamping and AverageAbsRpm tests live in BlackBoxAirGyroDampingTests.cs.
    /// </summary>
    [Category("Fast")]
    public class BlackBoxAirPitchRollTests
    {
        [Test]
