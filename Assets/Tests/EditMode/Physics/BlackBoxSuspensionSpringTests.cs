...
{
    /// <summary>
    /// Black-box tests for SuspensionMath.ComputeSpringLength.
    /// Force-with-damping tests live in BlackBoxSuspensionForceTests.cs.
    /// </summary>
    [Category("Fast")]
    public class BlackBoxSuspensionSpringTests
    {
        [Test]
