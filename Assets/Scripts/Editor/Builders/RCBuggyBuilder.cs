...
namespace R8EOX.Editor.Builders
{
    ...
    /// colliders, and core components.
    /// Visual/mesh helpers are in RCBuggyMeshBuilder.
    /// </summary>
    internal static class RCBuggyBuilder
    {
        ...
        internal static GameObject BuildRCBuggy()
        {
            ...
            Material darkGrey = RCBuggyMeshBuilder.CreateMaterial("DarkGrey", new Color(0.2f, 0.2f, 0.2f));
            Material medGrey  = RCBuggyMeshBuilder.CreateMaterial("MediumGrey", new Color(0.5f, 0.5f, 0.5f));
            Material blueSemi = RCBuggyMeshBuilder.CreateMaterial("BlueSemi",
                new Color(0.18f, 0.45f, 0.9f, 0.85f), transparent: true);
            Material blueSolid = RCBuggyMeshBuilder.CreateMaterial("BlueSolid", new Color(0.18f, 0.45f, 0.9f));
            Material tireMat   = RCBuggyMeshBuilder.CreateMaterial("BlackTire", new Color(0.05f, 0.05f, 0.05f));
            Material hubMat    = RCBuggyMeshBuilder.CreateMaterial("WhiteHub", new Color(0.9f, 0.9f, 0.9f));

            RCBuggyMeshBuilder.AddBodyMeshes(root, darkGrey, medGrey, blueSemi, blueSolid);
            RCBuggyMeshBuilder.AddControlArms(root, darkGrey);
            ...
            Material tireMat, Material hubMat, int layer)
        {
            ...
            RCBuggyMeshBuilder.BuildWheelVisual(pivot, "WheelVisual", tireRadius, tireHeight, tireMat, layer);
            RCBuggyMeshBuilder.BuildWheelVisual(pivot, "HubVisual",   hubRadius,  hubHeight,  hubMat,  layer);
        }
