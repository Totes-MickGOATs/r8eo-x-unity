...
| `WheelInertiaConfig.cs` | `WheelInertiaConfig` | Wheel inertia: MoI, gyroscopic scale, reaction scale for air physics |

## Usage

1. Create asset: Assets → Create → R8EOX → Motor Preset / Suspension Config / Traction Config / Wheel Inertia Config
